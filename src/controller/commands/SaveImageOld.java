 ...
 */
public class SaveImageOld implements CollagerCommand {
   ...
   */
  public SaveImageOld(String imagePath) {
  ...
  public void execute(ProjectModel model, ProjectView view) throws IOException {
      ...
      for (Map.Entry<String, LayerInterface> layer : allLayers.entrySet()) {
        ...
        //LayerInterface filteredLayer = currentFilter.apply(currentLayer, currentLayer);
        if (index == 0) {
